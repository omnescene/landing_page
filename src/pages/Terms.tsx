...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    title: 'Contact Us',
    body: [
      <><p>Questions about these Terms may be sent to Us:</p><ul><li>By email: <a href="mailto:support@omnescene.com" className="text-cyan hover:text-cyan-soft">support@omnescene.com</a></li><li>Online: <a href="https://omnescene.com/" target="_blank" rel="noopener noreferrer" className="text-cyan hover:text-cyan-soft">omnescene.com</a></li><li>By phone: +94 11 239 6745</li></ul></>
    ]
  }
];
